...
export default function Footer() {
  return (
    <footer className="bg-panel py-4 text-center border-t border-gray-200 dark:border-gray-700 mt-auto">
      <a 
        href="https://www.linkedin.com/in/ian-martin-torres/" 
        target="_blank" 
        rel="noreferrer"
        className="inline-flex items-center gap-2 text-muted hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm font-medium"
      >
