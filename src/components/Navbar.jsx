...
export default function Navbar({ view, setView }){
  ...
  return (
    <div className="bg-panel shadow-md p-4 flex flex-wrap md:flex-nowrap items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        <h1 className="text-xl md:text-2xl font-bold text-primary">Gestion Stock App</h1>
        <a href="https://github.com/iatorres/ControlStock_WebApp" target="_blank" rel="noreferrer" className="text-muted hover:text-primary transition-colors" title="Ver en GitHub">
      ...
      <div className="flex items-center space-x-2 md:space-x-4 order-last md:order-none w-full md:w-auto justify-center">
